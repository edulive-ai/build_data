...
class YOLOBatchProcessor:
    def __init__(self, input_dir, output_dir):
        ...
        self.all_detections_dir = self.output_dir / "all_detections_hdhtoan1_q4"
        # self.valid_detections_dir = self.output_dir / "valid_detections"
        self.cropped_dir = self.output_dir / "cropped_hdhtoan1_q4"
...
def main():
    # === Cấu hình đường dẫn ===
    INPUT_DIR = "/home/batien/Desktop/build_data/hdhtoan1_q4"  # Thay đổi đường dẫn này
